...
export function Navbars() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <a href="#" className="flex items-center" onClick={()=>navigate('/aboutus')}>
          About
        </a>
      </Typography>
      <Typography
  ...
  return (
    <Navbar className="mx-auto border-0  w-[90%] px-4 py-2 lg:px-8 lg:py-4 py-5 bg-[#3F5F6FA]">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className="flex items-center gap-x-0">
          <Button variant="text" size="sm" className="hidden lg:inline-block" onClick={()=>navigate('/price')}>
            <span>Pricing</span>
          </Button>
          ...
          <Button
          size="sm"
          className="hidden rounded-[30px] lg:inline-block bg-[#6161FF] text-white hover:from-blue-600 hover:to-purple-600"
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          {navList}
          <div className=" py-0">
            <Button fullWidth variant="gradient" size="sm" className=" bg-black bg-blue-500">
              <span>Price</span>
            </Button>
     
            <Button fullWidth variant="gradient" size="sm" className=" bg-blue-500 mt-3 ">
              <span>Sign in</span>
            </Button>
          </div>
        </div>
